...
func KeycloakProvider() *schema.Provider {
	return &schema.Provider{
		ResourcesMap: map[string]*schema.Resource{
			...
			"keycloak_oidc_username_idp_mapper":                    resourceKeycloakOidcUsernameIdpMapper(),
			"keycloak_oidc_user_attribute_idp_mapper":              resourceKeycloakOidcUserAttributeIdpMapper(),
