...
func KeycloakProvider() *schema.Provider {
	return &schema.Provider{
		ResourcesMap: map[string]*schema.Resource{
			...
			"keycloak_saml_username_idp_mapper":                    resourceKeycloakSamlUsernameIdpMapper(),
			"keycloak_saml_user_attribute_idp_mapper":              resourceKeycloakSamlUserAttributeIdpMapper(),
			"keycloak_saml_role_idp_mapper":                        resourceKeycloakSamlRoleIdpMapper(),
			"keycloak_saml_hardcoded_role_idp_mapper":              resourceKeycloakSamlHardcodedRoleIdpMapper(),
			"keycloak_oidc_username_template_importer_mapper":      resourceKeycloakOidcUsernameTemplateImporterMapper(),
			"keycloak_oidc_user_attribute_importer_mapper":         resourceKeycloakOidcUserAttributeImporterMapper(),
			"keycloak_oidc_role_idp_mapper":                        resourceKeycloakOidcRoleIdpMapper(),
			"keycloak_oidc_hardcoded_role_idp_mapper":              resourceKeycloakOidcHardcodedRoleIdpMapper(),
			"keycloak_hardcoded_user_session_attribute_idp_mapper": resourceKeycloakHardcodedUserSessionAttributeIdpMapper(),
			"keycloak_hardcoded_attribute_idp_mapper":              resourceKeycloakHardcodedAttributeIdpMapper(),
