...
func KeycloakProvider() *schema.Provider {
	return &schema.Provider{
		ResourcesMap: map[string]*schema.Resource{
			...
			"keycloak_hardcoded_user_session_attribute_idp_mapper": resourceKeycloakOidcIdentityProviderMapper(),
			"keycloak_hardcoded_attribute_idp_mapper":              resourceKeycloakSamlIdentityProviderMapper(),
